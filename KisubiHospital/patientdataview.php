  ...
  <div id="wrapper">
    ...
    <ul class=" navbar-nav bg-gradient-success sidenav sidebar sidebar-dark accordion " id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center"  href="#">
        ...
        <div class="sidebar-brand-text mx-3">Patient Records</div><h6 class="m-0 font-weight-bold text-primary">
      </a>
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col-auto">
             <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">PATIENT NAME</div>
             </div>
                    <div class="col mr-2">
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col-auto">
               <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Hospital Case No.</div>
             </div>
                       <div class="col mr-2">
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
            ...
            <div  id="findings" class="col-xl-8 col-lg-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                   <h6 class="m-0 font-weight-bold text-primary">OPD Findings <a style='margin-left: 450px; text-decoration:none;' class='text-secondary' href="opd_form.php"> <i class="fa 
                   fa-plus"></i></a></h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
...
echo ' <tr>
    <td class= "text-center"> <b><a style= "color:navy;" href="opdf.php?opdid='.$f_id.'"> '.$f_historypresentillness.' </a></b> </td>
    <td class= "text-center"> <b><a style= "color:navy;" href="opdf.php?opdid='.$f_id.'"> '.$f_date.' </a> </b> </td>
    <td class= "text-center"> <b><a style= "color:navy;" href="opdf.php?opdid='.$f_id.'"> '.$f_hospital.' </a> </b> </td>
...
?>
                ...
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Admission <a style='margin-left: 550px; text-decoration:none;' class='text-secondary' href='admissionviewform.php'> <i class="fa 
                   fa-plus"></i></a></h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
...
echo ' <tr>
    <td class="text-center"> <b><a style="color:navy;" href= "admissionf.php?adid='.$ad_id.'" > '.$ad_wardname.' </a></b> </td>
    <td class="text-center"> <b><a style="color:navy;" href="admissionf.php?adid='.$ad_id.'"> '.$ad_date.' </a> </b> </td>
    <td class="text-center"> <b><a style="color:navy;"" href="admissionf.php?adid='.$ad_id.'"> '.$ad_dischargedate.' </a> </b> </td>
    <td class="text-center"> <b><a style="color:navy;"" href="admissionf.php?adid='.$ad_id.'"> '.$f_hospital.' </a> </b> </td>
