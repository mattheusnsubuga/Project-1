...
$u_id=$_GET['eid'];
$sql = "SELECT * from realusers where u_id=$u_id";
...
$sql= "UPDATE  realusers set u_id=$u_id, u_name = '$u_name', u_password='$u_password',u_role='$u_role' where u_id=$u_id";
...
<body id="page-top">
 ...
 <div class='alert-primary text-center'><div class="text-center"> Kisubi Hospital <b>admin</b></div></div>   
</div>
 ...
 <!-- Divider -->
      ...
      <li class="nav-item active">
         <!-- Nav Item - Tables -->
        <a class="nav-link collapsed " href="admin_hope.php">
        ...
        <div class="container-fluid">
         ...
         <h5 class="mb-2 text-gray-800"> Add Users </h5>
            ...
            <div class="card-body">
                ...
                <form action="" id="add_user_form" class="form-horizontal user" method="post" accept-charset="utf-8">
<div class="container-fluid">
...
<div class="col-sm-2">
     <div style="margin-bottom:17px;">
        ...
        <div class="h5 mb-1 font-weight-bold text-gray-800"><input class="form-control " type="text" name="a_user" placeholder="Enter Username" value="<?php echo $u_name  ?>" ></div>
...
<div class="col-sm-3">
        ...
        <div class="h5 mb-1 font-weight-bold text-gray-800"><input class="form-control  " type="password" name="a_pass" placeholder="Enter Password" value="<?php echo $u_password  ?>" ></div>
   ...
   <div class="col-sm-2">
           ...
           <select name="a_rule" class="form-control">
      ...
      <div class="col-sm-2">
        <div class="text-gray-800">
         <button  style='margin-top:19px;background: navy;' type='submit' class='btn btn-success btn-icon-split' name='edit' href=''> 
