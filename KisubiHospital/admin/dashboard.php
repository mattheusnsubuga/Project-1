                                   ...
                                   <div class="row no-gutters align-items-center">
                                       <div class="col mr-2">
                                           <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                              Total Kisubi Hospital Findings</div>
                                              <?php
                                $cpresult =" SELECT * FROM findings where f_hospital = 'Kisubi Hospital' " ;
                       ...
                       <div class="col-xl-3 col-md-6 mb-4">
                           <div class="card border-left-primary shadow h-100 py-2">
                               <div class="card-body">
                                   <div class="row no-gutters align-items-center">
                                       <div class="col mr-2">
                                           <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Kisubi Hospital Admissions
                                           </div>
                                           <div class="row no-gutters align-items-center">
                                               <div class="col-auto">
                                                   ...
                                                   <a href="./pages/users.php" >
                                                       <p><?php
                                $cdresult =" SELECT * FROM admission_record where f_hospital = 'Kisubi Hospital' " ;
                                       ...
                                       <div class="col mr-2">
                                           ...
                                           <div class="row no-gutters align-items-center">
                                               <div class="col-auto">
                                                   <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                                        <p> <?php
                                $cdresult =" SELECT `f_diagnosis` FROM `findings` where f_hospital = 'Kisubi Hospital' GROUP BY `f_diagnosis` ORDER BY COUNT(*) DESC LIMIT 1 " ;
                               if($cddisplay=mysqli_query($conn, $cdresult)) {
