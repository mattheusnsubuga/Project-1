        ...
        <div class="container-fluid">
         ...
         <h5 class="mb-2 text-gray-800"> Add Doctor </h5>
            ...
            <div class="card-body">
                ...
                <form action="http://localhost/patientrecords/addusercontrol/add_doctor/#demo" id="add_doctor_form" class="form-horizontal user" method="post" accept-charset="utf-8">
<div class="container-fluid">
...
<div class="col-sm-3">
        ...
        <div class="h5 mb-1 font-weight-bold text-gray-800"><input class="form-control  " type="text" name="a_lname" placeholder="Enter Lastname" value="" ></div>
         <div class="text-danger text-center"></div>
               </div>
   ...
   <div class="col-sm-3">
      ...
      <div class="col-sm-2">
        <div class="text-gray-800">
         <button  style='margin-top:19px;' type='submit' class='btn btn-success btn-icon-split' name='submit' href='http://localhost/patientrecords/admissioncontrol/add_user/#demo'> 
       ...
       <div class="container">
              ...
              <div class="table">
                <table class="table table-bordered " id="dataTable" width="100%" cellspacing="0">
                 ...
                 <td class='text-center'>Marilyn.Madrid</td>                 <td class='text-center'>Pediatrician</td>                 <td class='text-center'>2019-04-24 18:03:20</td>           
                 <td class='text-center'>
                  <a style='margin-left:5px;' class='btn btn-danger' href='http://localhost/patientrecords/addusercontrol/delete_doctor/24' onClick='return doconfirm() '>Delete
                  </a></td>                   
                 ...
                 <td class='text-center'>Noa.Santiago</td>                 <td class='text-center'>Dermatologist</td>                 <td class='text-center'>2019-04-24 18:08:08</td>           
                 <td class='text-center'>
                  <a style='margin-left:5px;' class='btn btn-danger' href='http://localhost/patientrecords/addusercontrol/delete_doctor/26' onClick='return doconfirm() '>Delete
                  </a></td>                   
                 ...
                 <td class='text-center'>James.Santos</td>                 <td class='text-center'>Ophthalmologist</td>                 <td class='text-center'>2019-04-24 18:09:35</td>           
                 <td class='text-center'>
                  <a style='margin-left:5px;' class='btn btn-danger' href='http://localhost/patientrecords/addusercontrol/delete_doctor/28' onClick='return doconfirm() '>Delete
                  </a></td>                   
                 ...
                 <td class='text-center'>John.Gomez</td>                 <td class='text-center'>Orthopedic.surgeon</td>                 <td class='text-center'>2019-04-24 18:13:41</td>           
                 <td class='text-center'>
                  <a style='margin-left:5px;' class='btn btn-danger' href='http://localhost/patientrecords/addusercontrol/delete_doctor/30' onClick='return doconfirm() '>Delete
                  </a></td>                   
                 ...
                 <td class='text-center'>Jobelle.Castro</td>                 <td class='text-center'>Psychiatrist</td>                 <td class='text-center'>2019-04-24 18:15:08</td>           
                 <td class='text-center'>
                  <a style='margin-left:5px;' class='btn btn-danger' href='http://localhost/patientrecords/addusercontrol/delete_doctor/32' onClick='return doconfirm() '>Delete
                  </a></td>                   
                 ...
                 <td class='text-center'>Maria.Cruz</td>                 <td class='text-center'>Gynecologist</td>                 <td class='text-center'>2019-04-25 11:43:29</td>           
                 <td class='text-center'>
                  <a style='margin-left:5px;' class='btn btn-danger' href='http://localhost/patientrecords/addusercontrol/delete_doctor/37' onClick='return doconfirm() '>Delete
                  </a></td>                   
                 ...
                 <td class='text-center'>Gabriel.Lopez</td>                 <td class='text-center'>Surgeon</td>                 <td class='text-center'>2019-05-03 06:40:26</td>           
                 <td class='text-center'>
                  <a style='margin-left:5px;' class='btn btn-danger' href='http://localhost/patientrecords/addusercontrol/delete_doctor/38' onClick='return doconfirm() '>Delete
                  </a></td>                   
                 ...
                 <td class='text-center'>Juan.Monton</td>                 <td class='text-center'>Emergency.Medicine.Specialist</td>                 <td class='text-center'>2019-05-03 06:47:50</td>           
                 <td class='text-center'>
                  <a style='margin-left:5px;' class='btn btn-danger' href='http://localhost/patientrecords/addusercontrol/delete_doctor/39' onClick='return doconfirm() '>Delete
                  </a></td>                   
