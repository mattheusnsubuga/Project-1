 ...
 <!-- ito n yung variable na kinomvert n na kay $data['topbar'] need mo lagyan ng $this->load->view(); then sa loob yung variable para maiload nya yung nilalaman ni variable $topbar which is yung script para sa navigation bar  --> 
       ...
       <div class="container">
              ...
              <div class="table">
                ...
                <form action="" id="add_multiple_findings" class="form-horizontal user" method="post" accept-charset="utf-8">
<div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        <div style="margin-bottom:17px;">
           ...
           <button style='margin-left: 410px; margin-bottom: 20px; text-decoration:none ; background-color: navy' type='submit' class='btn btn-success btn-icon-split' name='opdsubmit' href='add_multiple_findings.html'> 
