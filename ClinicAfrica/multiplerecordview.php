    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        <div style="margin-bottom:17px;">
           ...
           <button style='margin-left: 410px; margin-bottom: 20px; text-decoration:none ; background-color: forestgreen' type='submit' class='btn btn-success btn-icon-split' name='opdsubmit' href='add_multiple_findings.html'> 
