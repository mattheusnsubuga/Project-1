...
<body id="page-top">
 ...
 <div class='alert-success text-center'><div class="text-center">Clinic Africa <b>admin</b></div></div>   
</div>
        ...
        <div class="container-fluid">
              ...
              <hr>
                 <div class="row "><!-- ROW 1 -->
                   ...
                   <div class="col-sm-4">
                     <h6 class="text-center"><b>CLINIC AFRICA KAJJANSI</b></h6>
                     <h5 class="text-center"><b>PATIENT RECORD</b></h5>
                   </div>
                   <div class="col-sm-4"></div>
                 </div>
            
                             <form action="http://localhost/patientrecords/admissioncontrol/edit_opd_form/1" id="opd_form" class="form-horizontal user" method="post" accept-charset="utf-8">
             ...
             <div style="margin-left: 50px;">
               <label>Hospital Case No.</label>              P-01            </div> 

                      <div style="margin-left: 900px;" class="col-xs-5 ">
             
                
                        <label>Date</label>                                <input type="date" class="form-control  "  name="date" value="2019-03-13">
                   ...
                   <div class="row">
                     <div style="margin-left: 4px;" class="col-sm-4">
                          <label>Lastname</label>                   <input type="text"  class="form-control  "  name="lname" placeholder="Lastname" value="Hassan">
                  <div class="text-danger text-center"></div>
                     </div>
                     <div class="col-sm-4">
                       <label>Firstname</label>                           <input type="text" style="margin-left: 4px;"  class="form-control  "  name="fname" placeholder="Firstname" value="Jenna">
                  <div class="text-danger text-center"></div>
                     </div>
                     <div class="col-sm-3">
                      <label>MiddleInitial</label>                       <input type="text" style="margin-left: 2px;" class="form-control  "  name="middlen" placeholder="Middleinitial" value="Castro">
                  <div class="text-danger text-center"></div>
                     </div>
                  ...
                  <div class="row">
                    <div style="margin-left: 4px;" class="col-sm-11">
                      <label>Address</label>                                <input type="text" style="margin-left: 7px;" class="form-control  "  name="address" placeholder="Permanent Address" value="San Carlos Heights Binangonan Rizal">
                  <div class="text-danger text-center"></div>
                    </div>          
                  </div>
                   <div class="row">
                     <div style="margin-left: 4px;" class="col-sm-2">
                       <label>Age</label>                                <input type="text" class="form-control  "  name="age" placeholder="Age" value="26">
                  <div class="text-danger text-center"></div>  
                     </div>
                    <div style="margin-left: 4px;" class="col-xs-3">
                       <label>Birthday</label>                                <input type="date" class="form-control "  name="datebirth" value="1992-07-03">
                     <div class="text-danger text-center"></div> 
                     </div>
                     <div style="margin-left: 4px;" class="col-sm-3">
                       <label>Birthplace</label>                                <input type="text" class="form-control  " placeholder="Birth Place"  name="birthplace" value="Cainta Rizal">
                     <div class="text-danger text-center"></div> 
                     </div>
                     <div style="margin-left: 4px;" class="col-sm-3">
                ...
                <div class="row">
                 <div style="margin-left: 30px;" class="col-xs-3">
                   ...
                   <div class="text-danger text-center"></div>
                     ...
                     <div style="margin-left: 30px;" class="col-xs-3">
                        <label>Mobile/Tel No.</label>                                <input type="number" class="form-control  " placeholder="Mobile/Tel No."  name="number" value="09293932931">
                     <div class="text-danger text-center"></div>

                    </div>

                    <div style="margin-left: 20px;" class="col-xs-3">
                        <label>Religion</label>                                <input type="text" class="form-control " placeholder="Religion"  name="religion" value="Catholic">
                     <div class="text-danger text-center"></div> 
                   </div>

                    <div style="margin-left: 20px;" class="col-xs-3">
                      <label>Occupation</label>                                <input type="text" class="form-control " placeholder="Occupation"  name="occup" value="Call Center">
                     <div class="text-danger text-center"></div>
                     </div>                   
                   </div>
                  </div>
                  <br><br>
                   <button style="margin-left:471px; background-color: forestgreen; " id="submitbtn" type="submit" class="btn btn-success btn-icon-split" name="submit">
