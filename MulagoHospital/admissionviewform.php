...
<!--Begin -->
 ...
 <div style="margin-left: 10px; margin-right: 10px;" class="row">
   ...
   <br><br>
           ...
           <button style='margin-left: 410px; margin-bottom: 20px; background-color: maroon; text-decoration:none' type='submit' class='btn btn-primary btn-icon-split' name='submit' href='http://localhost/patientrecords/admissioncontrol/admit_form'> 
