...
<script src="https://cdn.jsdelivr.net/npm/chart.js@2.8.0"></script>
  ...
  <script src kisubi= "http://localhost/patientrecords/assets/js/scripts/jquery.canvasjs.min.js"></script>
               ...
               <label>Hospital Case No.</label>              P-01            </div> 
                ...
                <div class="row">
                 <div style="margin-left: 30px;" class="col-xs-3">
                  ...
                  <br><br>
                   <button style="margin-left:471px; background-color: maroon; " id="submitbtn" type="submit" class="btn btn-primary btn-icon-split" name="submit">
