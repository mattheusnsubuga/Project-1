...
<body id="page-top">
 ...
 <div class='alert-secondary text-center'><div class="text-center">Mulago Hospital <b>Cerk</b></div></div>  
                ...
                <div class="row">
                 <div style="margin-left: 30px;" class="col-xs-3">
                  ...
                  <br><br>
                   ...
                   <button style="margin-left:430px;  background-color: maroon;" id="submitbtn" type="submit" class="btn btn-success btn-icon-split" name="submit">
